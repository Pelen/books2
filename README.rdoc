...
Rozszerzenie aplikacji (My Books)[https://github.com/rails4/my_books] o kilka dodatków łącznie z wdrożeniem jej na Heroku.
...
* dodanie infinity scrolling zgodnie z przykładem dostępnym tutaj[https://gist.github.com/qbraksa/5606187]
